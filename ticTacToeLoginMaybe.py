            ...
            while gameIsPlaying:
                if turn == 'X':
                    ...
                    if 'playerMove' in params:
                        ...
                        theBoard = game.makeMove(theBoard, 'X', playerMove)
                    ...
                    if game.isBoardFull(theBoard):
                        ...
                        turn = 'O'  # ***again update program name def

                if turn == 'O':
                    page += '</br>O\'s turn</br>'
                    if 'playerMove' in params:
                        playerMove = params['playerMove'][0]
                        TTT.makeMove(game, theBoard, 'O', playerMove)
                    ...
                    if game.isWinner(theBoard, 'O'):  # ***update program name defs
                        game.drawBoard(theBoard)
                        print('Hooray! You have won the game!')  # HTML
                        gameIsPlaying = False
                    if game.isBoardFull(theBoard):
